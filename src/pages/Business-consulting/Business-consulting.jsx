        ...
        <div className="mx-auto max-w-7xl px-5 py-16 md:px-10 md:py-20">
          ...
          <div className="mx-auto mb-8 w-full max-w-3xl text-center md:mb-12 lg:mb-16">
            ...
            <div className="flex items-stretch justify-center">
              <a
                href="#"
                className="mr-5 inline-block rounded-md  px-8 py-4 text-center font-semibold text-blue-500 md:mr-6 lg:mr-8 border-2 border-red-500"
              >
                TALK TO AN EXPERT
          ...
          {/* Hero Image */}
          <img
            src="https://img.freepik.com/premium-vector/professional-business-advisor-with-client-office-consultation-meeting_1322553-61703.jpg?size=626&ext=jpg&ga=GA1.1.92873607.1726129462&semt=ais_hybrid-rr-similar"
            alt=""
